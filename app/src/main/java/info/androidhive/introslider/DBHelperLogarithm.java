...
public class DBHelperLogarithm extends SQLiteOpenHelper {
    private static final int DATABASE_VERSION = 1;
    // Database Name
    private static final String DATABASE_NAME = "Logarithm";
    // tasks table name
    private static final String TABLE_QUEST = "logarithm_table";
    ...
    public DBHelperLogarithm(Context context) {
...
// Inserting Row
    ...
    public List<Logarithm_question> getAllQuestions() {
        List<Logarithm_question> quesList = new ArrayList<Logarithm_question>();
// Select All Query
...
// looping through all rows and adding to list
        if (cursor.moveToFirst()) {
            do {
                Logarithm_question quest = new Logarithm_question();

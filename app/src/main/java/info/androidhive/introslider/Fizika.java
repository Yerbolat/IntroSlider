...
public class Fizika extends AppCompatActivity {
    List<Fizika_question> quesList;
    int score=0;
    int qid=0;
    Fizika_question currentQ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DbHelperPhysics db=new DbHelperPhysics(this);
...
//                rdc.setTextColor(Color.BLACK);
                ...
                if(qid<5){
                    ...
                    Intent intent = new Intent(Fizika.this, ResultActivity.class);
                    Bundle b =  new Bundle();
...
// Inflate the menu; this adds items to the action bar if it is present.
    ...
    private void setQuestionView()
    {
        ...
        rda.setText(Html.fromHtml(currentQ.getOPTA()));
        rdb.setText(Html.fromHtml(currentQ.getOPTB()));
        rdc.setText(Html.fromHtml(currentQ.getOPTC()));
        rdd.setText(Html.fromHtml(currentQ.getOPTD()));
        qid++;
    }
}
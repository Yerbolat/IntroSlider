...
public class Derivative extends AppCompatActivity {
    List<Derivative_question> quesList;
    int score=0;
    int qid=0;
    Derivative_question currentQ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DBHelperDerivative db=new DBHelperDerivative(this);
...
//                rdc.setTextColor(Color.BLACK);
                ...
                if(qid<10){
                    ...
                    Intent intent = new Intent(Derivative.this, ResultActivity.class);
                    Bundle b =  new Bundle();

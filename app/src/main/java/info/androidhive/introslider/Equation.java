...
/**
 * Created by NURAKHMET on 28.03.2017.
 */

public class Equation extends AppCompatActivity {
    List<Equation_question> quesList;
    int score=0;
    int qid=0;
    Equation_question currentQ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DBHelperEquation db=new DBHelperEquation(this);
...
//                rdc.setTextColor(Color.BLACK);
                ...
                if(qid<10){
                    ...
                    Intent intent = new Intent(Equation.this, ResultActivity.class);
                    Bundle b =  new Bundle();
